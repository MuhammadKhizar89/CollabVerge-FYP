...
const WhyChooseUs = () => {
  ...
  return (
    <div className="w-full bg-white py-16 px-4 sm:px-2">
      <div className="mx-auto">
        ...
        <div className="flex gap-x-4">
          {/* Card 1 */}
          <div className="rounded-2xl border border-gray-200 p-8 bg-white flex flex-col justify-center w-[60%]">
            <div className="text-6xl sm:text-8xl font-light text-black mb-3 mt-20">45K+</div>
    ...
    {paymentLogos.map((logo, index) => {
      ...
      return (
        ...
        <div className="flex mt-6 gap-x-4">
          ...
          {/* Card 4 */}
          <div className="rounded-2xl border border-gray-200 bg-white p-8 flex flex-col justify-center w-[30%]">
            <div className="text-6xl sm:text-8xl font-light text-black mt-16">25M+</div>
