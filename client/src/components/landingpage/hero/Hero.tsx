...
function Hero() {
    return (
        <main className="flex flex-col mt-14 lg:mt-0 lg:flex-row w-full   gap-5 lg:justify-between lg:px-10">
            <div className="flex flex-col items-start justify-center gap-3 lg:w-1/2 ">
                <div className="border p-2 rounded-full text-xs flex gap-1 items-center ">
                    <DiamondIcon />
                    #1 Collaboration platform</div>
                <h6 className="text-5xl 2xl:text-6xl ">Where Brands & Influencers Meet <span className="font-playfair italic text-primary">Create </span>to Create Global Impact</h6>
